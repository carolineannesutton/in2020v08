...
ccomp_1 <- ccomp_1 %>% 
  mutate(Taxa_Groups = 
           ifelse(ACat %in% c("Tunicates","Siphonophore","Ctenophore","Medusa"), "Gelatinous",
           ifelse(ACat%in%c("Crustacean","Prawn","Krill","Amphipods","Gnathaphausia",                          "Isopods","Gnathapahausia","Copepod","Ostacod"),"Crustacean",
...
Shot_3 <- Shot_2 %>% 
  select(Site = Site1, daylight, Deployment,Depth_Stratum) 
