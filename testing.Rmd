...
#create higher grouping "Acoustic_Category"
```{r Taxa_updated Groups}
...
ccomp_4 <- ccomp_3_ACATDB_TGroups %>%
  ...
  select(Voyage,Deployment,Acc,Acc_ed,ACat,Taxa_Groups,CAAB,Taxa_updated,CAAB_updated,Taxa_updated,Count,weight_g,Storage_temp,Preservative) 
...
## Standardising the catch comp using Volumen Filtered
...
ccomp_6_SumShot <- ccomp_5_summary %>% 
  ...
  select(ID,Site,daylight,Depth_Stratum,Deployment,ACat,Taxa_Groups,Taxa_updated,CAAB_updated,
...
# Dups <-ccomp_6_SumShot[duplicated(ccomp_6_SumShot$ID), ]
