...
#plot length data
  length_sites <-  select(length, Site, daylight, Depth_Stratum, 
...
# But: 'Salpa thompsoni solitary' and 'Salpa thompsoni aggregate' will remain seperate

## this has resoved the duplciate problem
